...
public class ErrorTextEng 
{
	static public String getErrorText( String a_strCode )
	{
        ...
        t_aTexts.put("BCSDB022","Unexpected character : await '%'");
        t_aTexts.put("BCSDB023","Unexpected character : P in multilinkages are not possible.");
        t_aTexts.put("BCSDB024","Unexpected residue : First residue of a sugar can not be probabilistic.");
        t_aTexts.put("BCSDB025","Unexpected residue : Probabilistic is not allowed in non repeating sugars.");
        t_aTexts.put("BCSDB026","Unexpected residue : Nested probabilistic is not allowed.");
        t_aTexts.put("BCSDB027","Unexpected character : Probabilistc value is not a number.");
        // cfg
        ...
        t_aTexts.put("CFG013","Uncertain subtrees and fragmented sugars are not allowed.");
        t_aTexts.put("CFG014","Unexpected character : missing closing &.");
        t_aTexts.put("CFG015","Unexpected character : Sequence should end after closing &.");
        t_aTexts.put("CFG016","Fragmented sugar must consist of at least three fragments.");
        // ogbi
        ...
        t_aTexts.put("GLSUITE001","Error in undetermined unit.");
        t_aTexts.put("GLSUITE002","Error with undetermined substituent.");
        t_aTexts.put("GLSUITE003","Bracketing incorrect.");
