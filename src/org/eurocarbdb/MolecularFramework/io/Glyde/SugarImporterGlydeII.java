...
public class SugarImporterGlydeII extends SugarImporter 
{
    ...
    private ArrayList<Substituent> m_aSubst = new ArrayList<Substituent>();
    ...
    private LinkageType getFromLinkageType(String a_strFrom, String a_strFromReplace, String a_strToReplace) throws SugarImporterException
    {
        ...
        else if ( t_strBefore.equals("N") )
        {
            return LinkageType.NONMONOSACCHARID;
        }
        else if ( t_strBefore.equals("P") )
        {
            return LinkageType.NONMONOSACCHARID;
        }
        else if ( t_strBefore.equals("S") )
        {
            return LinkageType.NONMONOSACCHARID;
        }
        else
    ...
    private boolean isSubstNoPosConnection(String a_connection) 
    {
        ...
        else if ( a_connection.equals("S") )
        {
            return true;
        }
        else if ( a_connection.equals("P") )
        {
            return true;
        }
        else if ( a_connection.equals("F") )
        {
            return true;
        }
        else if ( a_connection.equals("Cl") )
        {
            return true;
        }
        else if ( a_connection.equals("Br") )
        {
            return true;
        }
        else if ( a_connection.equals("I") )
        {
            return true;
        }
        return false;
