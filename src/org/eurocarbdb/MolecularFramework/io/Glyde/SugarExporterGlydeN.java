 ...
 * @author Logan
 */
public class SugarExporterGlydeN implements GlycoVisitor
{
	...
	/**
	 * @throws SugarVisitorException 
	 * @see org.glycomedb.molecule.sugar.visitor.MolecularFrameWork.util.visitor.SugarVisitor#getTraverser(org.glycomedb.molecule.sugar.visitor.MolecularFrameWork.util.visitor.SugarVisitor)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.MolecularFrameWork.util.visitor.SugarVisitor#clear()
	 */
	public void clear() 
	{
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#visit(org.glycomedb.molecule.sugar.data.Monosaccharide)
	 */
	public void visit(Monosaccharide a_objMonosaccharid) throws GlycoVisitorException 
	{
		...
		this.m_iResCounter++;
		t_objResidue.setAttribute("ref",this.m_strReferenceDB + "=" + a_objMonosaccharid.getGlycoCTName() + this.collapseSubst(a_objMonosaccharid));
	...
	private String collapseSubst(Monosaccharide a_monosaccharid)
    {
	    String t_strResult = "";
//	    GlycoVisitorNodeType t_visitor = new GlycoVisitorNodeType();
//	    ArrayList<CollapseSubst> t_aSubst = new ArrayList<CollapseSubst>(); 
//	    for (GlycoNode t_node : a_monosaccharid.getChildNodes())
//        {
//            Substituent t_subst =  t_visitor.getSubstituent(t_node);
//            if ( t_subst != null )
//            {
//                // found a subst, is it collapsable?
//                CollapseSubst t_collapse = this.getCollapsObject(t_subst);
//                if ( t_collapse != null )
//                {
//                    t_aSubst.add(t_collapse);
//                }
//            }
//        }
//	    // sort collapse subst
//	    ComparatorCollapseSubst t_comparator = new ComparatorCollapseSubst(); 
//	    Collections.sort(t_aSubst,t_comparator);
//	    // build the string
//	    for (CollapseSubst t_collapseSubst : t_aSubst)
//        {
//            t_strResult += t_collapseSubst.getGlydeString();
//        }
        return t_strResult;
    }

    /**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#visit(org.glycomedb.molecule.sugar.data.Substituent)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#visit(org.glycomedb.molecule.sugar.data.SugarUnitCyclic)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#visit(org.glycomedb.molecule.sugar.data.SugarUnitAlternative)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor.util.visitor.GlycoVisitor#visit(org.glycomedb.molecule.sugar.data.MolecularFrameWork.sugar.SugarUnitRepeat)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#visit(org.glycomedb.molecule.sugar.data.GlycoEdge)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#visit(org.glycomedb.molecule.sugar.data.UnvalidatedGlycoNode)
	 */
	...
	/**
	 * @see org.glycomedb.molecule.sugar.visitor.SugarVisitor#start(org.glycomedb.molecule.sugar.data.Sugar)
	 */
