...
public class GlycoVisitorToGlycoCTforLinearCode implements GlycoVisitor {
	...
	public GlycoVisitorToGlycoCTforLinearCode(
			MonosaccharideConversion a_objTranslator) {
		super();
	...
	public void visit(SugarUnitRepeat a_objRepeate)
			throws GlycoVisitorException {
		if (this.m_objTraverser.getState() == GlycoTraverser.ENTER) {
			GlycoVisitorToGlycoCTforLinearCode t_objVisitor = new GlycoVisitorToGlycoCTforLinearCode(
