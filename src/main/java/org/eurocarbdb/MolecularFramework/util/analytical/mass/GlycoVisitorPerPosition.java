 ...
 *
 */
public class GlycoVisitorPerPosition implements GlycoVisitor
{
	...
	public void visit(Monosaccharide a_objMonosaccharide) throws GlycoVisitorException
	{
		...
		if ( t_iKetoCount > 1 )
		{
		    t_dMass += (t_iKetoCount-1) * this.m_objMasses.getModificationMass(ModificationType.KETO, this.m_bMonoisotopic,2);		    
		}
		...
		// TODO
//		// calculate PMe and PAc positions
//		this.m_iPerMePos += this.m_objPositions.getSuperclassMe(a_objMonosaccharide.getSuperclass());
//		this.m_iPerAcPos += this.m_objPositions.getSuperclassAc(a_objMonosaccharide.getSuperclass());
//		// modifications
//		for (Iterator<Modification> t_iterModi = a_objMonosaccharide.getModification().iterator(); t_iterModi.hasNext();)
//		{
//			Modification t_objModi = t_iterModi.next();
//			this.m_iPerMePos += this.m_objPositions.getModiMe(t_objModi);
//			this.m_iPerAcPos += this.m_objPositions.getModiAc(t_objModi);
//		}
//		// linkages parent
//		if ( a_objMonosaccharide.getParentEdge() != null )
//		{
...
//			{
//				LinkageType t_objLinkageType = t_iterLinkages.next().getChildLinkageType();
//				this.m_iPerMePos += this.m_objPositions.getLinkageMe(t_objLinkageType);
//				this.m_iPerAcPos += this.m_objPositions.getLinkageAc(t_objLinkageType);
//
//			}
//		}
//		// linkages child
...
//		}
	...
	public void visit(Substituent a_objSubstituent) throws GlycoVisitorException
	{
		...
		// calculate PMe and PAc positions
		// TODO
//		this.m_iPerMePos += this.m_objPositions.getSubstMe(a_objSubstituent,t_iLinkageCount);
//		this.m_iPerAcPos += this.m_objPositions.getSubstAc(a_objSubstituent,t_iLinkageCount);
	}
